...
public class Eje1Empleado {
    ...
    public Eje1Empleado(double nit, String nombre, String apellido, String direccion, double salario, int bandera) {
        this.nit = nit;
        this.nombre = nombre;
    ...
    public String informacion(Eje1Empleado e) {
        String datos = "";

        datos += "Introdusca el N° de NIT :" + e.getNit() + "\n";
        datos += "Introdusca el Nombre del Empleado : " + e.getNombre() + "\n";
        datos += "Introdusca el Apellido del Empleado : " + e.getApellido() + "\n";
        datos += "Introdusca la direccion : " + e.getDireccion() + "\n";
        datos += "El salario Devengado es : $" + e.getSalario() + "\n";
        return datos;
    }
